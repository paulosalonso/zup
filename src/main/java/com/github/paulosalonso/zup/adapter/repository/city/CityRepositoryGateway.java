...
import static com.github.paulosalonso.zup.adapter.repository.city.CityEntityMapper.*;
...
public class CityRepositoryGateway implements ReadCityPort, CreateCityPort, DeleteCityPort, UpdateCityPort {
    ...
    public Page<City> findByCriteria(CityCriteria criteria) {
        return toPage(repository.findAll(findByCityCriteria(criteria),
                buildPageable(criteria)), CityEntityMapper::toList);
    }
